function initMap() {
  var e = { lat: 11.943928760399627, lng: 108.43009449141566 },
...
$(document).ready(function () {
  ...
  for (var n = 0; n < e.length; n++) {
    var o =
      ...
      '&amp;via=thb_lee&amp;hashtags=BinhandDuong&amp;count=horizontal"style="width:105px; height:21px;"></iframe><iframe src="//www.facebook.com/plugins/like.php?href=' +
      encodeURIComponent(window.location) +
  ...
  var r = createCalendar({
    ...
    data: {
      ...
      end: new Date("Apr 10, 2022 17:00"),
      address: "77/1 Hai Thuong, Ward 5, Da Lat, Lam Dong",
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Mr. Binh at +84 932512535.",
    },
  });
  $("#add-to-cal").html(r),
    $("#rsvp-form").on("submit", function (e) {
      ...
      $("#alert-wrapper").html(
        ...
        "9d2eed1f555a5f9ff00bdb8388963750" !== MD5($("#invite_code").val()) &&
        "8174017745b8d9d01fc6e1fda260b9df" !== MD5($("#invite_code").val())
          ? $("#alert-wrapper").html(
              alert_markup(
                "danger",
          ...
          : $.post(
              "https://script.google.com/macros/s/AKfycbytCADd3XjIdFG6AhcgmDX1OKaNMNHzBBc7uaH7jXy43C-puVA/exec",
              t
            )
              .done(function (e) {
                console.log(e),
