  ...
  $("#add-to-cal").html(r),
    $("#rsvp-form").on("submit", function (e) {
      ...
      $("#alert-wrapper").html(
        ...
        MD5(parseInt($("#invite_code").val())) !== "9d2eed1f555a5f9ff00bdb8388963750"
          ? $("#alert-wrapper").html(
              alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrect.")
            )
          : $.post(
              "https://script.google.com/macros/s/AKfycbxWjR0oSneOQXPmTwSQe_grmlAutIQGlyt3reom-NXSoFn-3wQHCzp7sNKNyzDdyj_w/exec", t
            )
              .success(function (e) {
                console.log(e),
                  "error" === e.result
