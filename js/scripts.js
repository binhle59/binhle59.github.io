$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;hashtags=binhduong&amp;count=horizontal"' +
            'style="width:105px; height:21px;">' +
            '</iframe>' +

            '<iframe src="//www.facebook.com/plugins/like.php?href=' + encodeURIComponent(window.location) + '&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=21&amp;appId=101094500229731&amp;width=150" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:21px;" allowTransparency="true"></iframe>';
...
/********************** RSVP **********************/
    ...
    if (MD5($('#invite_code').val()) !== '9d2eed1f555a5f9ff00bdb8388963750') {
        ...
        $.post('https://script.google.com/macros/s/AKfycbz46Ls1QEwvvNDV7QVX9ibZWZERGXS3E49Bahpsdh83wa8pDpvmJdPW1BJ6Pa0MRK2S/exec', data)
            .done(function (data) {
                console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 11.943928760399627, lng: 108.43009449141566};
...
function initBBSRMap() {
    var la_fiesta = {lat: 11.943928760399627, lng: 108.43009449141566};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
